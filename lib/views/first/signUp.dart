  ...
  PreferredSize _header(BuildContext context){
    return PreferredSize(
      ...
      child: Container(
        ...
        child: const Center(
          child: Text('WELLCOME TO CITYPHONE', style: TextStyle(color: Colors.white, fontSize: 30, fontWeight: FontWeight.bold),),
        ),
      )
    );
  }
  ...
  Widget _inputFieldColumn(){
    return Column(
      ...
      children: [
        ...
        SizedBox(height: 20,),
        InputFieldCustom(controller: userName, hintText: 'Your phone', isObsucre: false),
        SizedBox(height: 20,),
  ...
  Widget _signUpBtn(BuildContext context){
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Text('Sign Up', style: TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.bold), textAlign: TextAlign.center,),
      ),
    );
  }
  ...
  Widget _signInBtn(BuildContext context){
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Text('Sign In', style: TextStyle(color: Colors.black, fontSize: 20, fontWeight: FontWeight.bold), textAlign: TextAlign.center,),
      ),
    );
  }
